...
contract('NGToken',function(accounts){
    ...
    it('initializes the contract with the correct values', function(){
        return NGToken.deployed().then(function(instance){
            ...
            assert.equal(name,"NG Token","has the correct name");
            return tokenInstance.symbol();
        }).then(function(symbol){
            assert.equal(symbol,"NG","has the correct symbol");
            return tokenInstance.standard();
        }).then(function(standard){
            assert.equal(standard,"NG Token v1.0","has the correct symbol");
        });
    });
